   ...
   <div class="">
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
               <div class="x_title">
                  <h2>Plugins Files<small>different form elements</small></h2>
               ...
               <div class="x_content">
                  ...
                  <table class="table table-striped table-bordered table-hover">
                  	...
                  	<tbody class="view_folders"></tbody>
                  </table>
                  <button class="btn btn-success activate-plugins pull-right">Save Changes</button>
               </div>
            </div>
         </div>
      </div>
...
<script>
	// $.post('./adp/get_plugins',function(data){
	// 	console.log(data);
	// 	create_body(data);
	// });
