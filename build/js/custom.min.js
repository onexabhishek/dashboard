...
function init_parsley() {
	if ("undefined" != typeof parsley) {
		...
		$("parsley:field:validate", function () {
			a()
		}), $(".form-insertt .btnstt").on("submit", function (e) {
			console.log($(this));
			$(".form-insert").parsley().validate(), a()
		});
		var a = function (e) {
			!0 === $(".form-insert").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"));
			// insert_form();
			console.log(e);
		};
		try {
